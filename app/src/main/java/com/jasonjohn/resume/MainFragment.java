...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bgImages = new Drawable[]{res.getDrawable(R.drawable.alex_marty_blur),res.getDrawable(R.drawable.jason_profile_3_blur),res.getDrawable(R.drawable.alex_marty_blur)};
        circleImages = new Drawable[]{res.getDrawable(R.drawable.jason_profile_3),res.getDrawable(R.drawable.alex_marty),res.getDrawable(R.drawable.alex_marty)};
